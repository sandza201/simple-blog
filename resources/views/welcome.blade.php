<x-blog-layout>
    <div class="bg-[#f6f4ed] min-h-screen flex flex-col-reverse md:flex-row items-center relative px-6 py-12">
        <img class="md:absolute md:right-0 md:top-1/2 md:bottom-1/2 md:-translate-y-1/2" src="https://i.ibb.co/qkhfWQg/7061503.png" alt="">
        <div class="mx-auto max-w-7xl h-full flex w-full">
